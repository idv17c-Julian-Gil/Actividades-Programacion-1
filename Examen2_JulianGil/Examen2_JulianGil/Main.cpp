...
int main()
{
	...
	while (examen != 6)
	{
		...
		int frase3 = rand() % 3 + 0;
		int frase4 = rand() % 3 + 0;
		cout << sujeto[frase1] << " " << adjetivo[frase2] << " " << verbo[frase3] << " " << adverbio[frase4] << " " << preposicion[frase2] << " " << sustantivo[frase1] << '\n' << endl;
		cout << sujeto[frase2] << " " << adjetivo[frase1] << " " << verbo[frase2] << " " << adverbio[frase3] << " " << preposicion[frase1] << " " << sustantivo[frase2] << '\n' << endl;
		examen++;
	}
